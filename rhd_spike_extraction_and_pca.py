...
def extract_and_classify_spikes(result, channel_index, threshold_ratio, pre_time, post_time, n_components):
...
if __name__ == '__main__':
    ...
    signal, time, aligned_time, spike_data, spikes, regular_spikes, random_spikes= extract_and_classify_spikes(result, 0, 0.3, 1, 2, 2)
